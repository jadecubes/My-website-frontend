...
| File | Exports |
|---|---|
| `api.ts` | `fetchProjects`, `fetchProject`, `fetchServices`, `sendContactMessage` |
| `dataService.ts` | `fetchPosts`, `getPostCoverImage` (blog/posts — endpoint not yet implemented in the backend) |
